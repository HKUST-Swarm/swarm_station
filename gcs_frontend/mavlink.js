...
mavlink.MAV_TYPE_FLARM = 32 // Onboard FLARM collision avoidance system
...
mavlink.MAV_CMD_DO_SET_ROI = 201 // Sets the region of interest (ROI) for a sensor set or the vehicle
                        ...
                        // vehicle attitude and the attitude of
                        // various sensors such as cameras.
mavlink.MAV_CMD_DO_DIGICAM_CONFIGURE = 202 // THIS INTERFACE IS DEPRECATED since 2018-01. Please use PARAM_EXT_XXX
                        // messages and the camera definition format
                        // described in https://mavlink.io/en/protocol
                        // /camera_def.html.
mavlink.MAV_CMD_DO_DIGICAM_CONTROL = 203 // THIS INTERFACE IS DEPRECATED since 2018-01. Please use PARAM_EXT_XXX
                        // messages and the camera definition format
                        // described in https://mavlink.io/en/protocol
                        // /camera_def.html.
...
mavlink.MAV_CMD_REQUEST_CAMERA_IMAGE_CAPTURE = 2002 // Re-request a CAMERA_IMAGE_CAPTURE packet. Use NAN for reserved values.
...
mavlink.MAV_CMD_VIDEO_STOP_STREAMING = 2503 // Stop the current video streaming
...
mavlink.MAVLINK_MSG_ID_NODE_REALTIME_INFO = 200
mavlink.MAVLINK_MSG_ID_NODE_RELATIVE_FUSED = 201
mavlink.MAVLINK_MSG_ID_SWARM_REMOTE_COMMAND = 202
...
*/
mavlink.messages.swarm_remote_command = function(lps_time, target_id, command_type, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10) {

    this.format = '<iiiiiiiiiiibB';
    this.id = mavlink.MAVLINK_MSG_ID_SWARM_REMOTE_COMMAND;
...
mavlink.messages.swarm_remote_command.prototype = new mavlink.message;

mavlink.messages.swarm_remote_command.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.lps_time, this.param1, this.param2, this.param3, this.param4, this.param5, this.param6, this.param7, this.param8, this.param9, this.param10, this.target_id, this.command_type]));
}
...
*/
mavlink.messages.drone_status = function(lps_time, flight_status, control_auth, commander_mode, rc_valid, onboard_cmd_valid, sdk_valid, vo_valid, bat_vol, x, y, z) {

    this.format = '<iffffBBBBBBB';
    this.id = mavlink.MAVLINK_MSG_ID_DRONE_STATUS;
    this.order_map = [0, 5, 6, 7, 8, 9, 10, 11, 1, 2, 3, 4];
    this.crc_extra = 58;
    this.name = 'DRONE_STATUS';

    this.fieldnames = ['lps_time', 'flight_status', 'control_auth', 'commander_mode', 'rc_valid', 'onboard_cmd_valid', 'sdk_valid', 'vo_valid', 'bat_vol', 'x', 'y', 'z'];
...
mavlink.messages.drone_status.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.lps_time, this.bat_vol, this.x, this.y, this.z, this.flight_status, this.control_auth, this.commander_mode, this.rc_valid, this.onboard_cmd_valid, this.sdk_valid, this.vo_valid]));
}
...
*/
mavlink.messages.drone_odom_gt = function(lps_time, source_id, x, y, z, q0, q1, q2, q3, vx, vy, vz) {

    this.format = '<ihhhhhhhhhhb';
    this.id = mavlink.MAVLINK_MSG_ID_DRONE_ODOM_GT;
...
mavlink.messages.drone_odom_gt.prototype = new mavlink.message;
